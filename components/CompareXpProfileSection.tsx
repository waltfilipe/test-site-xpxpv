  ...
  const precisionMetrics: MetricSpec[] = [
    {
      ...
      barKeys: ["prec_coe_league_bar", "prec_display"],
    ...
    },
    {
      ...
      barKeys: ["xpass_coe_pct_league_bar", "xpass_coe_pct_pool_bar"],
      tip: m.precision.generalCoeTip,
      formatValue: formatXAccPlus,
    },
    {
      ...
      barKeys: ["xpass_long_coe_pct_league_bar", "xpass_long_coe_pct_pool_bar"],
      tip: m.precision.generalCoeTip,
      formatValue: formatXAccPlus,
    },
  ];
