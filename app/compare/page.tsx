...
import { POSITION_FAMILIES, type PositionFamilyOption } from "@/lib/positionFamilies";
...
export default function ComparePage() {
  ...
  const [positionFamilies, setPositionFamilies] = useState<readonly PositionFamilyOption[]>(POSITION_FAMILIES);
