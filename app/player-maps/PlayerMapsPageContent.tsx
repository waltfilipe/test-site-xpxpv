...
import { getMapsOptions, getPassMap, getPlayerOptions } from "@/lib/api";
import { useI18n } from "@/lib/i18n/context";

function PlayerMapsContent() {
  const { m } = useI18n();
  ...
  return (
    <div className="container">
      <PageHero title={m.nav.playerMaps} subtitle={m.maps.playerMapsSubtitle} icon="fa-user-group" />
...
export function PlayerMapsPageContent() {
  return (
